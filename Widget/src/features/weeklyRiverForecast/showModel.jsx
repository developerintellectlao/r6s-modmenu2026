            ...
            {keyChk === "legend" && (
                <Stack >
                    ...
                    <Table>
                        <TableBody>
                            {[
                                { label: "Stable", description: "Water level no increase/decrease"},
                                { label: "Increasing", description: "Increasing water level"},
                                { label: "Decreasing", description: "Decreasing water level" },
                            ].map((row, index) => (
                                <TableRow key={index}>

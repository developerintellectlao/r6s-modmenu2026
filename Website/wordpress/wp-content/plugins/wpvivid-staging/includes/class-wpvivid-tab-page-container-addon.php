...
class WPvivid_Tab_Page_Container_Addon extends WPvivid_Tab_Page_Container
{
        ...
        foreach ($this->tabs as $tab)
        {
            ...
            if(isset($tab['can_delete']))
            {
                if(isset($tab['redirect']))
                {
                    ...
                    echo '<span class="nav-tab-delete-img-addon dashicons dashicons-no-alt wpvivid-dashicons-grey" redirect="'.$tab['redirect'].'" style="width: 15px; height: 15px; font-size: 15px; padding-top: 0.4em;">';
                    echo '</div>';
                }
                else
                {
                    echo '<div>';
                    echo '<span class="'.$span_class.'" style="'.$span_style.'"></span><span style="padding-right: 1em;">'.$tab['title'].'</span>';
                    echo '<span class="nav-tab-delete-img-addon dashicons dashicons-no-alt wpvivid-dashicons-grey" style="width: 15px; height: 15px; font-size: 15px; padding-top: 0.4em;">';
                    echo '</div>';
                }
            }
            else

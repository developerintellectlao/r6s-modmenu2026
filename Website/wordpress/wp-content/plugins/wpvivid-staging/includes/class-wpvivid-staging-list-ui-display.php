...
class WPvivid_Staging_List_UI_Display
{
    ...
    public function output_staging_site_cell($id,$staging)
    {
        ...
        ?>
            ...
            {
                ?>
            <div class="wpvivid-one-coloum" style="border:2px solid #8bc34a;padding-top:0em; margin-top:1em" id="<?php echo esc_attr($id); ?>">
    ...
    public function load_staging_sites_list_js()
    {
        ...
        <script>
            function wpvivid_get_staging_site_radio(staging_site_id,fresh_install,mu_single,mu,action)
            {
                ...
                var select_tip = 'Notice: Please do not refresh or close the page until the process completes. As it could cause some unexpected errors.';

...
class WPvivid_Staging_Copy_Files_Ex
{
    ...
    public function get_copy_dir_list($key,&$src_path,&$des_path)
    {
        ...
        else if($key=='wp-content')
        {
            ...
            $exclude_regex[]='#^'.preg_quote($this -> transfer_path($this->get_content_dir()).DIRECTORY_SEPARATOR.'aiowps_backups', '/').'#';
            */

            $local_setting=get_option('wpvivid_local_setting');
            if(isset($local_setting['path']))
                $exclude_regex[]='#^'.preg_quote($this -> transfer_path($this->get_content_dir()).DIRECTORY_SEPARATOR. $local_setting['path'], '/').'#';
            ...
            {
                $exclude_regex[]='#^'.preg_quote($this -> transfer_path($this->get_content_dir()).'/'.WPVIVID_UPLOADS_ISO_DIR, '/').'#';
            }

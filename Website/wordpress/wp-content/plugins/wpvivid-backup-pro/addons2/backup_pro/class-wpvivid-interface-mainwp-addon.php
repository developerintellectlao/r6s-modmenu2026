    ...
    public function wpvivid_set_general_setting_addon_mainwp($data){
        ...
        try {
            if(isset($setting)&&!empty($setting)) {
                ...
                if(isset($wpvivid_common_setting['rollback_max_remote_backup_count']))
                {
                    $setting['wpvivid_common_setting']['rollback_max_remote_backup_count'] = $wpvivid_common_setting['rollback_max_remote_backup_count'];
                }

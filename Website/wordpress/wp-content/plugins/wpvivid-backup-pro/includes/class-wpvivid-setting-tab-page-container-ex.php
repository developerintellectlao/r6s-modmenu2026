...
{
    include_once WPVIVID_BACKUP_PRO_PLUGIN_DIR . 'includes/class-wpvivid-tab-page-container.php';
}

class WPvivid_Setting_Tab_Page_Container_Ex extends WPvivid_Tab_Page_Container
{

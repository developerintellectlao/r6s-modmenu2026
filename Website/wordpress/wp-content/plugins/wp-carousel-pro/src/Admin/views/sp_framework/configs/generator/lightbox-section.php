					...
					array(
						...
						'fields' => array(
							array(
								...
								'text_width' => 95,
								'dependency' => array( 'wpcp_carousel_type|wpcp_logo_link_show', 'any|==', 'image-carousel,mix-content,external-carousel|l_box', true ),
							),
							array(
								...
								'min'             => 0,
								'max'             => 20000,
								'dependency'      => array( 'wpcp_carousel_type|wpcp_logo_link_show|l_box_autoplay', 'any|==|==', 'image-carousel,mix-content,external-carousel|l_box|true', true ),
							),
							array(
								'id'         => 'l_box_loop',
								'type'       => 'switcher',
							...
							array(
								...
								'dependency' => array( 'wpcp_carousel_type|wpcp_logo_link_show|wpcp_post_detail_position', 'any|==|!=', 'image-carousel,mix-content,external-carousel|l_box|with_overlay', true ),
							),
							array(
								'id'         => 'l_box_icon_style',
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'default'    => '#ffffff',
								'dependency' => array( 'wpcp_carousel_type|wpcp_logo_link_show|wpcp_l_box_image_caption', 'any|==|==', 'image-carousel,mix-content,external-carousel|l_box|true', true ),
							),
							array(
								'id'         => 'l_box_desc',
								'type'       => 'switcher',
							...
							array(
								...
								'default'    => '#ffffff',
								'dependency' => array( 'wpcp_carousel_type|wpcp_logo_link_show|l_box_desc', 'any|==|==', 'image-carousel,mix-content,external-carousel|l_box|true', true ),
							),
							array(

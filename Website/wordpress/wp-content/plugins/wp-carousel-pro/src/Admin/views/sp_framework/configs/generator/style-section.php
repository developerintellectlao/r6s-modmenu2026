					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'title_help' => '<div class="sp_wpcp-img-tag"><img src="' . WPCAROUSEL_URL . 'Admin/img/help-visuals/content-box-size.svg" alt="Content Box Size"></div><div class="sp_wpcp-info-label">' . __( 'Content Box Size', 'wp-carousel-pro' ) . '</div><a class="sp_wpcp-open-live-demo" href="https://wordpresscarousel.com/content-box-size/" target="_blank">Live Demo</a>',
								'default'    => 50,
								'min'        => 5,
								'max'        => 100,
								'unit'       => '%',
							...
							array(
								...
								'default'    => 40,
								'unit'       => 'px',
								'dependency' => array( 'wpcp_carousel_type', '==', 'video-carousel', true ),
							),
							array(
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'title_help' => __( '<div class="sp_wpcp-info-label">Zoom</div><div class="sp_wpcp-short-content">This feature lets you choose a specific zoom effect when hovering over an image for an engaging experience.</div><a class="sp_wpcp-open-live-demo" href="https://wordpresscarousel.com/post-carousel-zoom-image-modes/" target="_blank">Live Demo</a>', 'wp-carousel-pro' ),
								'options'    => array(

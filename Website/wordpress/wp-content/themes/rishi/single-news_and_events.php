        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-8 page-content">
                    <h3 class="theme-color"><?php the_title();?></h3>
                    ...
                    <div class="mb-10">
                        ...
                        <a class="resp-sharing-button__link"
                            href="https://facebook.com/sharer/sharer.php?u=<?=get_current_pageURL()?>" target="_blank"
                        ...
                        <a class="resp-sharing-button__link"
                            href="https://twitter.com/intent/tweet/?text=<?= the_title() ?>&amp;url=<?=get_current_pageURL()?>"
                        ...
                        <a class="resp-sharing-button__link"
                            href="mailto:mrcmedia@mrcmekong.org/?subject=<?= the_title() ?>&amp;body=<?=get_current_pageURL()?>"
                        ...
                        <a class="resp-sharing-button__link"
                            href="https://www.linkedin.com/shareArticle?mini=true&amp;url=<?=get_current_pageURL()?>&amp;title=<?= the_title() ?>&amp;summary=<?= the_title() ?>&amp;source=<?=get_current_pageURL()?>"
                            target="_blank" rel="noopener" aria-label="">
                        ...
                        <a class="resp-sharing-button__link"
                            href="https://api.whatsapp.com//send?text=<?=get_current_pageURL()?>" target="_blank"
                            rel="noopener" aria-label="">
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="<?php echo $accordion_header_id;?>">
                                                    <button class="accordion-button" type="button"
                                                        ...
                                                        data-bs-target="#<?php echo $accordion_collapse;?>"
                                                        aria-expanded="true"
                                                        aria-controls="<?php echo $accordion_collapse;?>">
                                                        <?php echo $title;?>
                                                    </button>
                                                </h2>
                                                <div id="<?php echo $accordion_collapse;?>"
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-12 ">
                                        <div class="js-video [youtube, widescreen]">
                                            <iframe src="<?php echo get_field('youtube_link');?>" allowfullscreen=""
                                                width="100%" data-ruffle-polyfilled=""></iframe>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 ">
                                    </div>
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <?php if(!empty(get_field('brochure_pdf'))){ 
                        $upload_dir = wp_upload_dir(); ?>
                    <div class="pb-20">
                        <div class="reading-box">
                            <h5 class="pt-10">Download the brochure.</h5>
                            <div class="captionImage leftAlone" style="">
                                <a rel="noopener" href="<?php echo get_field('brochure_pdf')['url'];?>" target="_blank">
                                    <img src="<?php echo $upload_dir['baseurl'].$upload_dir['subdir'].'/Digital-Technology-Bifold-Brochure-Final-02__ResizedImageWzM3NSwyNjVd.png';?>"
                                        alt="download brochuer"></a>
                    ...
                    <div class="social-small-magazine">
                        <ul>
                            <li class="facebook">
                                <a href="https://www.facebook.com/mrcmekong" target="_blank"><i
                                        class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                            <li class="youtube">
                                <a href="http://www.youtube.com/mrcmekongorg" target="_blank"><i
                                        class="fab fa-youtube"></i>
                                </a>
                            </li>
                            <li class="twitter">
                                <a href="http://twitter.com/MRCMekong" target="_blank"><svg fill="white"
                            ...
                            <li class="linkedin">
                                <a href="https://www.linkedin.com/company/mrcsecretariat" target="_blank"><i

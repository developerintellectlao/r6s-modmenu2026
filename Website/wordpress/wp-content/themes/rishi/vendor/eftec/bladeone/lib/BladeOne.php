...
class BladeOne
{
     ...
     * @return string
     */
    public function _e($phrase, 'rishi')
    {
     ...
     * @return string
     */
    public function _n($phrase, $phrases, $num = 0, 'rishi')
    {
        if ((!\array_key_exists($phrase, static::$dictionary))) {
            $this->missingTranslation($phrase);
        ...
        return ($num <= 1) ? $this->_e($phrase, 'rishi') : $this->_e($phrases, 'rishi');
    }
